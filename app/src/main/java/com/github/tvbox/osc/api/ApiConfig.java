...
public class ApiConfig {
  ...
  public static String FindResult(String json, String configKey) {
    ...
    try {
      ...
      if (content.startsWith("2423")) {
        ...
        String key =
            AES.rightPadding(
                content.substring(content.indexOf("$#") + 2, content.indexOf("#$")), "0", 16);
  ...
  public void loadConfig(boolean useCache, LoadConfigCallback callback, Activity activity) {
    ...
    File cache =
        new File(App.getInstance().getFilesDir().getAbsolutePath() + "/" + MD5.encode(apiUrl));
      ...
      if (index != -1) {
        ...
        if (extUrl != null && !extUrl.isEmpty()) {
          ...
          if (extUrl.startsWith("http") || extUrl.startsWith("clan://")) {
            ...
            extUrlFix =
                new String(
                    Base64.decode(extUrl, Base64.DEFAULT | Base64.URL_SAFE | Base64.NO_WRAP),
                    "UTF-8");
          }
         ...
         /* if (extUrlFix.startsWith("clan://")) {
          ...
          extUrlFix =
              Base64.encodeToString(
                  extUrlFix.getBytes("UTF-8"), Base64.DEFAULT | Base64.URL_SAFE | Base64.NO_WRAP);
     ...
     /*   if (livesOBJ.has("epg")) {
        ...
        if (!lives.contains("type")) {
          ...
          if (type.equals("0")) {
            ...
            // 设置epg
            if (a.has("epg")) {
              String epg = a.get("epg").getAsString();
              Hawk.put(HawkConfig.EPG_URL, epg);
            }
            ...
            if (url.startsWith("http")) {
              url =
                  Base64.encodeToString(
                      url.getBytes("UTF-8"), Base64.DEFAULT | Base64.URL_SAFE | Base64.NO_WRAP);
            }
      ...
      JsonArray ijkJsonArray =
          infoJson.has("ijk")
              ...
              : defaultJson.get("ijk").getAsJsonArray();
      ...
      {"category":1,"name":"dns_cache_timeout","value":"600000000"}]}]*/
        ...
        baseOpt.put("4|opensles","0");
        baseOpt.put("4|overlay-format","842225234");
        baseOpt.put("4|framedrop","1");
        baseOpt.put("4|soundtouch","1");
        baseOpt.put("4|start-on-prepared","1");
        baseOpt.put("1|http-detect-range-support","0");
        baseOpt.put("1|fflags","fastseek");
        baseOpt.put("2|skip_loop_filter","48");
        baseOpt.put("4|reconnect","1");
        baseOpt.put("4|enable-accurate-seek","0");
        baseOpt.put("4|mediacodec","1");
        baseOpt.put("4|mediacodec-auto-rotate","1");
        baseOpt.put("4|mediacodec-handle-resolution-change","1");
        baseOpt.put("4|mediacodec-hevc","1");
        baseOpt.put("4|dns_cache_timeout","600000000");
  ...
  private void parseJson(String apiUrl, String jsonStr) {
    ...
    a.addProperty("name", "TXT");
    a.addProperty("type", 0);
    a.addProperty("url", "https://video.kdphoto.cn/output_zww.txt");
    elements.add(a);
    infoJson.add("lives", elements);
    try {
  ...
  public void loadLives(JsonArray livesArray) {
    ...
    for (JsonElement groupElement : livesArray) {
      ...
      channelIndex = 0;
      for (JsonElement channelElement :
          ((JsonObject) groupElement).get("channels").getAsJsonArray()) {
  ...
  public Spider getCSP(SourceBean sourceBean) {
    ...
    if (js)
      return jsLoader.getSpider(
          sourceBean.getKey(), sourceBean.getApi(), sourceBean.getExt(), sourceBean.getJar());
    return jarLoader.getSpider(
        sourceBean.getKey(), sourceBean.getApi(), sourceBean.getExt(), sourceBean.getJar());
  }
